package com.s.t.m.common.fileupload;


import com.s.t.m.common.core.configurer.MultipartConfigurer;
         ...
         while (iterator.hasNext()) {
            ...
            if (file != null) {
               ...
               if (myFileName.trim() != "") {
                  ...
                  // 创建文件夹
                  String folderPath = MultipartConfigurer.SAVEFILEPATH + File.separator + folderName();
                  ...
                  list.add(MultipartConfigurer.SAVEFILEPATH + "//" + myFileName);
               }
            }
         }
      }
