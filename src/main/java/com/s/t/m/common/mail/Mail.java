...
public class Mail {
     ...
     * 发送静态文件的路径
     */
    private String staticImgFile; 
    
    public String getStaticImgFile() {
        return staticImgFile;
    }

    public void setStaticImgFile(String staticImgFile) {
        this.staticImgFile = staticImgFile;
    }
